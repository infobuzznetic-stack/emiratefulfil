        ...
        {catalog.filter((p) => p.name.toLowerCase().includes(searchQuery.toLowerCase()) || (p.category || "").toLowerCase().includes(searchQuery.toLowerCase())).map((p, i) => {
          ...
          return (
            ...
            >
              ...
              {isLocked && (
                <div className="absolute inset-0 z-20 flex flex-col items-center justify-center rounded-2xl" style={{ background: "rgba(11,31,58,0.8)", backdropFilter: "blur(4px)" }}>
...
const PLAN_DATA = [
  {
    ...
    features: [
      ...
      { label: "Customised Packaging", on: false },
  ...
  },
  {
    ...
    features: [
      ...
      { label: "Customised Packaging", on: true },
